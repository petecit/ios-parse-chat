# Lab 4 - *ios-parse-chat*

**ios-parse-chat** is a Chat app using an [open source Parse](http://parseplatform.org/) backend.
...
<img src='https://i.imgur.com/90VAu6b.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
